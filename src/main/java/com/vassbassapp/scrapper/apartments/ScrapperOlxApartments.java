...
public class ScrapperOlxApartments implements Scrapper<Apartment> {
    ...
    @Override
    public Collection<Apartment> get() {
        ...
        try {
            ...
            List<Future<Collection<Apartment>>> f = es.invokeAll(scrappers);
            f.forEach(fu -> {
                try {
